# -*- coding: utf-8 -*-
"""
Created on Sat Mar  9 09:54:54 2019
...
#def xiaobo(data):   
data=pd.read_csv('PMD20181122009ML00ZJ.csv',usecols=['脉搏'], encoding = 'gb18030')
data = data[0:3020]
#plt.plot(data)
...
'''
s = np.zeros(128)
cA, cD = pywt.dwt(data['脉搏'], 'db2')#0-50,50-100
#cA, cD = pywt.dwt(dataframe['和'], 'db2')#0-50,50-100
r = np.zeros(1511)
m = pywt.idwt(cA,r, 'db2')
...
ed
#plt.plot(data['脉搏'])
cA1, cA2 = pywt.dwt(cA, 'db2')#0-25, 25-50
#cA1
cA11, cA12 = pywt.dwt(cA1, 'db2')#0-12.5, 12.5-25

cA111, cA112 = pywt.dwt(cA11, 'db2')#0-6.25, 6.25-12.5

cA1111, cA1112 = pywt.dwt(cA111, 'db2')#0-3.125, 3.125-6.25
cA11111, cA11112 = pywt.dwt(cA1111, 'db2')#0-1.5625, 1.5625-3.125
cA111111, cA111112 = pywt.dwt(cA11111, 'db2')#0-0.78125, 0.78125-1.5625***********
cA111121, cA111122 = pywt.dwt(cA11112, 'db2')#1.5625-2.34375, 2.34375-3.125*******
'''
s[0] = abs(cA111111).sum()
s[1] = abs(cA111112).sum()
s[2] = abs(cA111121).sum()
s[3] = abs(cA111122).sum()
cA11121, cA11122 = pywt.dwt(cA1112, 'db2')#3.125-4.6875, 4.6875-6.25
cA111211, cA111212 = pywt.dwt(cA11121, 'db2')#3.125-3.90605, 3.90625-4.6875********
cA111221, cA111222 = pywt.dwt(cA11122, 'db2')#4.6875-5.46875, 5.46875-6.25*********
s[4] = abs(cA111211).sum()
s[5] = abs(cA111212).sum()
s[6] = abs(cA111221).sum()
s[7] = abs(cA111222).sum()

cA1121, cA1122 = pywt.dwt(cA112, 'db2')#6.25-9.375, 9.375-12.5
cA11211, cA11212 = pywt.dwt(cA1121, 'db2')#6.25-7.8125, 7.8125-9.375
cA112111, cA112112 = pywt.dwt(cA11211, 'db2')#6.25-7.03125, 7.03125-7.8125***********
cA112121, cA112122 = pywt.dwt(cA11212, 'db2')#7.8125-8.59375, 8.59375-9.375**********
s[8] = abs(cA112111).sum()
s[9] = abs(cA112112).sum()
s[10] = abs(cA112121).sum()
s[11] = abs(cA112122).sum()
cA11221, cA11222 = pywt.dwt(cA1122, 'db2')#9.375-10.9375, 10.9375-12.5
cA112211, cA112212 = pywt.dwt(cA11221, 'db2')#9.375-10.15625, 10.15625-10.9375********
cA112221, cA112222 = pywt.dwt(cA11222, 'db2')#10.9375-11.71875, 11.71875-12.5*********
...
cA121, cA122 = pywt.dwt(cA12, 'db2')#12.5-18.75, 18.75-25

cA1211, cA1212 = pywt.dwt(cA121, 'db2')#12.5-15.625, 15.625-18.75
cA12111, cA12112 = pywt.dwt(cA1211, 'db2')#12.5-14.0625, 14.0625-15.625
cA121111, cA121112 = pywt.dwt(cA12111, 'db2')#125.-13.28125, 13.28125-14.0625***********
cA121121, cA121122 = pywt.dwt(cA12112, 'db2')#14.0625-14.84375, 14.84375-15.625*******
s[16] = abs(cA121111).sum()
s[17] = abs(cA121112).sum()
s[18] = abs(cA121121).sum()
s[19] = abs(cA121122).sum()
cA12121, cA12122 = pywt.dwt(cA1212, 'db2')#15.625-17.1875, 17.1875-18.75
cA121211, cA121212 = pywt.dwt(cA12121, 'db2')#15.625-16.40625, 16.40625-17.1875********
cA121221, cA121222 = pywt.dwt(cA12122, 'db2')#17.1875-17.96875, 17.96875-18.75-*********
s[20] = abs(cA121211).sum()
s[21] = abs(cA121212).sum()
s[22] = abs(cA121221).sum()
s[23] = abs(cA121222).sum()

cA1221, cA1222 = pywt.dwt(cA122, 'db2')#18.75-21.875, 21.875-25
cA12211, cA12212 = pywt.dwt(cA1221, 'db2')#18.75-20.3125, 20.3125-21.875
cA122111, cA122112 = pywt.dwt(cA12211, 'db2')#18.75-19.53125, 19.53125-20.3125***********
cA122121, cA122122 = pywt.dwt(cA12212, 'db2')#20.3125-21.09375, 21.09375-21.875**********
s[24] = abs(cA122111).sum()
s[25] = abs(cA122112).sum()
s[26] = abs(cA122121).sum()
s[27] = abs(cA122122).sum()
cA12221, cA12222 = pywt.dwt(cA1222, 'db2')#21.875-23.4375, 23.4375-25
cA122211, cA122212 = pywt.dwt(cA12221, 'db2')#21.875-22.65625, 22.65625-23.4375********
cA122221, cA122222 = pywt.dwt(cA12222, 'db2')#23.4375-24.21875, 24.21875-25*********
...
#cA2
cA21, cA22 = pywt.dwt(cA2, 'db2')#25-37.5,37.5-50

cA211, cA212 = pywt.dwt(cA21, 'db2')

cA2111, cA2112 = pywt.dwt(cA211, 'db2')
cA21111, cA21112 = pywt.dwt(cA2111, 'db2')
cA211111, cA211112 = pywt.dwt(cA21111, 'db2')#***********
cA211121, cA211122 = pywt.dwt(cA21112, 'db2')#***********
s[32] = abs(cA211111).sum()
s[33] = abs(cA211112).sum()
s[34] = abs(cA211121).sum()
s[35] = abs(cA211122).sum()
cA21121, cA21122 = pywt.dwt(cA2112, 'db2')
cA211211, cA211212 = pywt.dwt(cA21121, 'db2')#********
cA211221, cA211222 = pywt.dwt(cA21122, 'db2')#*********
s[36] = abs(cA211211).sum()
s[37] = abs(cA211212).sum()
s[38] = abs(cA211221).sum()
s[39] = abs(cA211222).sum()

cA2121, cA2122 = pywt.dwt(cA212, 'db2')
cA21211, cA21212 = pywt.dwt(cA2121, 'db2')
cA212111, cA212112 = pywt.dwt(cA21211, 'db2')#***********
cA212121, cA212122 = pywt.dwt(cA21212, 'db2')#**********
s[40] = abs(cA212111).sum()
s[41] = abs(cA212112).sum()
s[42] = abs(cA212121).sum()
s[43] = abs(cA212122).sum()
cA21221, cA21222 = pywt.dwt(cA2122, 'db2')
cA212211, cA212212 = pywt.dwt(cA21221, 'db2')#********
cA212221, cA212222 = pywt.dwt(cA21222, 'db2')#*********
...
cA221, cA222 = pywt.dwt(cA22, 'db2')

cA2211, cA2212 = pywt.dwt(cA221, 'db2')
cA22111, cA22112 = pywt.dwt(cA2211, 'db2')
cA221111, cA221112 = pywt.dwt(cA22111, 'db2')#***********
cA221121, cA221122 = pywt.dwt(cA22112, 'db2')#***********
s[48] = abs(cA221111).sum()
s[49] = abs(cA221112).sum()
s[50] = abs(cA221121).sum()
s[51] = abs(cA221122).sum()
cA22121, cA22122 = pywt.dwt(cA2212, 'db2')
cA221211, cA221212 = pywt.dwt(cA22121, 'db2')#********
cA221221, cA221222 = pywt.dwt(cA22122, 'db2')#*********
...
m1 = pywt.idwt(cA111111,r1, 'db2')
m2 = pywt.idwt(cA11111,r2, 'db2')
m2 = m2[:-1]
m3 = pywt.idwt(m2,r3, 'db2')
m3 = m3[:-1] 
m4 = pywt.idwt(m3,r4, 'db2')
m5 = pywt.idwt(m4,r5, 'db2')
m5 = m5[:-1]
m6 = pywt.idwt(m5,r6, 'db2')
m6 = m6[:-1]
m7 = pywt.idwt(m6,r7, 'db2')

p = pywt.idwt(cA1111,r3, 'db2')
p = p[:-1]
p0 = pywt.idwt(cA111,r4, 'db2')
p1 = pywt.idwt(p0,r5, 'db2')
p1 = p1[:-1]
p2 = pywt.idwt(p1,r6, 'db2')
p2 = p2[:-1]
p3 = pywt.idwt(p2,r7, 'db2')

m8 = p3-m7
plt.plot(p3[0:1000])
#data1 = pd.DataFrame(m8)
#data1.to_csv('data1.csv')
'''
m1 = pywt.idwt(r1,cA222222, 'db2')
m2 = pywt.idwt(r2,m1, 'db2')
m2 = m2[:-1]
m3 = pywt.idwt(r3,m2, 'db2')
m3 = m3[:-1] 
m4 = pywt.idwt(r4,m3, 'db2')
m5 = pywt.idwt(r5,m4, 'db2')
m5 = m5[:-1]
m6 = pywt.idwt(r6,m5, 'db2')
m6 = m6[:-1]
m7 = pywt.idwt(r7,m6, 'db2')
plt.plot(m7[0:100])
'''