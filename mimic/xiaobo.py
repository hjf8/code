# -*- coding: utf-8 -*-
"""
Created on Fri Mar  8 15:48:22 2019
...
def xiaobo(data):   
#data=pd.read_csv('PMD20181122003ML00MJ.csv',usecols=['脉搏'], encoding = 'gb18030')
    data = data[0:3020]
...
#wavelet = pywt.Wavelet('db1')
    '''
    s = np.zeros(128)
    cA, cD = pywt.dwt(data, 'db2')#0-50,50-100
...
s[127] = abs(cD222222).sum()
    ...
    #m2 = pywt.idwt(m1,r2, 'db2')
    m2 = m2[:-1]
    m3 = pywt.idwt(m2,r3, 'db2')
    m3 = m3[:-1] 
    m4 = pywt.idwt(m3,r4, 'db2')
    m5 = pywt.idwt(cA11,r5, 'db2')
    m5 = m5[:-1]
